...
public final class Constants {
     ...
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = .7; // FIXME Measure and set wheelbase
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(91.7468); // FIXME Measure and set
                                                                                          // front
    // left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(240.20233154); // FIXME Measure and set
                                                                                                // front
    // right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(100.0964); // FIXME Measure and set back
                                                                                          // left
    // steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(276.7593); // FIXME Measure and set back
    // right steer offset
}
